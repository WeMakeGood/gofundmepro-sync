-- Migration: 002_add_consent_fields
...
ALTER TABLE supporters ADD COLUMN last_email_consent_date DATETIME DEFAULT NULL;
ALTER TABLE supporters ADD COLUMN last_sms_consent_date DATETIME DEFAULT NULL;
ALTER TABLE supporters ADD COLUMN last_emailed_at DATETIME DEFAULT NULL;
